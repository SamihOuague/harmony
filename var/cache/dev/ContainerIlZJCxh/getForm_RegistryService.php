...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\BienFormType' => ['privates', 'App\\Form\\BienFormType', 'getBienFormTypeService', true],
            'App\\Form\\ContactFormType' => ['privates', 'App\\Form\\ContactFormType', 'getContactFormTypeService', true],
            'App\\Form\\LotFormType' => ['privates', 'App\\Form\\LotFormType', 'getLotFormTypeService', true],
            'App\\Form\\NewsFormType' => ['privates', 'App\\Form\\NewsFormType', 'getNewsFormTypeService', true],
            'App\\Form\\PageFormType' => ['privates', 'App\\Form\\PageFormType', 'getPageFormTypeService', true],
            'App\\Form\\ProgrammeFormType' => ['privates', 'App\\Form\\ProgrammeFormType', 'getProgrammeFormTypeService', true],
            'App\\Form\\RappelFormType' => ['privates', 'App\\Form\\RappelFormType', 'getRappelFormTypeService', true],
            ...
            'App\\Form\\BienFormType' => '?',
            'App\\Form\\ContactFormType' => '?',
            'App\\Form\\LotFormType' => '?',
            'App\\Form\\NewsFormType' => '?',
            'App\\Form\\PageFormType' => '?',
            'App\\Form\\ProgrammeFormType' => '?',
            'App\\Form\\RappelFormType' => '?',
