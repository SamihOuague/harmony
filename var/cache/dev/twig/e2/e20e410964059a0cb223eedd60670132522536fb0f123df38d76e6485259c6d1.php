...
<div id=\"team\" class=\"d-flex justify-content-center align-items-center flex-column\" style=\"height: 500px; 
    ...
    <div style=\"background-color: rgba(255, 255, 255, 0.9); max-width: 650px; padding: 3% 6%;\">
        ...
        <br/>
        <p class=\"text-secondary\" style=\"font-size: 18px; font-family: 'Montserrat';\">Notre équipe est notre plus grande force, elle travaille avec bienveillance et positivité.</p>

        <p class=\"text-secondary\" style=\"font-size: 18px; font-family: 'Montserrat';\">La diversité des talents et la personnalité de chacun participent a notre savoir-faire.</p>
        <p class=\"text-secondary\" style=\"font-size: 18px; font-family: 'Montserrat';\">Par notre engagement, nous faisons évoluer, ensemble, le paysage urbain dans le bon sens.</p>
    </div>
