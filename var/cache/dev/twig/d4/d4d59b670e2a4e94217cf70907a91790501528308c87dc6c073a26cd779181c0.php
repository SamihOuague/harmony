...
class __TwigTemplate_c0cbd868fd91387ff5d5a31801d9d2dbe2531ea8eac47ec5f5d1ca075efa7fd8 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\" style=\"height: 100%; overflow: hidden; max-width: 100%;\">
        ...
        if ((isset($context["pages"]) || array_key_exists("pages", $context) ? $context["pages"] : (function () { throw new RuntimeError('Variable "pages" does not exist.', 29, $this->source); })())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                ...
                echo "\" class=\"";
                echo (((twig_get_attribute($this->env, $this->source, $context["page"], "numero", [], "any", false, false, false, 31) == 1)) ? ("") : ("d-none"));
...
{% endblock %}
", "presentation/index.html.twig", "/var/www/html/harmony/templates/presentation/index.html.twig");
    }
}
