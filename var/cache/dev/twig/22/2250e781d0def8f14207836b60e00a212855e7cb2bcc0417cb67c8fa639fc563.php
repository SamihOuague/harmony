...
class __TwigTemplate_9c3e33a290a023d83379b46bb772beac91244e411b02cc3e7ca982496d78f27a extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper h-100\">
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 12, $this->source); })()), "user", [], "any", false, false, false, 12)) {
            // line 13
            echo "        <a class=\"btn btn-outline-success\" href=\"/programme/new\">Ajouter un programme</a>
        <div style=\"padding-top: 50px;\">
            ";
            // line 15
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["programmes"]) || array_key_exists("programmes", $context) ? $context["programmes"] : (function () { throw new RuntimeError('Variable "programmes" does not exist.', 15, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["prog"]) {
                ...
                echo "</a></h2>
                    <div>
                        <a href=\"/programme/";
                // line 19
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["prog"], "id", [], "any", false, false, false, 19), "html", null, true);
...
";
    ...
    {
        return array (  134 => 26,  130 => 24,  120 => 20,  116 => 19,  109 => 17,  106 => 16,  102 => 15,  98 => 13,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper h-100\">
    {% if (app.user) %}
        <a class=\"btn btn-outline-success\" href=\"/programme/new\">Ajouter un programme</a>
        <div style=\"padding-top: 50px;\">
            {% for prog in programmes %}
                <div class=\"alert alert-secondary d-flex justify-content-between\">
                    <h2><a class=\"text-dark\" href=\"/dashboard/{{prog.id}}/bien\">{{prog.title}}</a></h2>
                    <div>
                        <a href=\"/programme/{{prog.id}}/delete\" class=\"btn btn-outline-danger\">Supprimer</a>
                        <a href=\"/programme/{{prog.id}}/edit\" class=\"btn btn-outline-primary\">Modifier</a>
                    </div>
                </div>
            {% endfor %}
        </div>
