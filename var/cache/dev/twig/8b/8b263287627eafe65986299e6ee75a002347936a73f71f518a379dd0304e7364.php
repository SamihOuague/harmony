...
class __TwigTemplate_6662aab7993344168952c13bb88a17dc5cd42f35a39b4a655d7f7daaf043e803 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 9
        if ((isset($context["pages"]) || array_key_exists("pages", $context) ? $context["pages"] : (function () { throw new RuntimeError('Variable "pages" does not exist.', 9, $this->source); })())) {
            // line 10
            echo "        ";
...
";
    ...
    {
        return array (  124 => 17,  121 => 16,  112 => 13,  106 => 12,  103 => 11,  98 => 10,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper container\">
    <h1 style=\"margin: 50px 0px;\">Liste des pages :</h1>
    <a href=\"{{path('app_new_page')}}\" class=\"btn btn-outline-success\" style=\"margin: 50px 0px\">Ajouter une page</a>
    {% if (pages) %}
        {% for page in pages %}
            <div class=\"alert alert-primary d-flex justify-content-between\">
                <h2>{{page.numero}} - {{page.titre|upper}}</h2>
                <a href=\"/page/{{page.id}}/delete\" class=\"btn btn-outline-danger d-flex align-items-center\">Supprimer</a>
            </div>
        {% endfor %}
    {% endif %}
...
{% endblock %}
", "page/index.html.twig", "/home/souaguen/Bureau/harmonypresent/templates/page/index.html.twig");
    }
}
